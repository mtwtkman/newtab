...
var $author$project$Main$DisplayBookmarks = {$: 'DisplayBookmarks'};
var $author$project$Main$Bookmark = F2(
	function (url, title) {
...
var $author$project$Main$init = function (flags) {
	...
	return _Utils_Tuple2(
		{bookmarks: bookmarks, draggable: $author$project$Main$dnd.model, viewMode: $author$project$Main$DisplayBookmarks},
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Main$EditBookmark = F2(
	function (a, b) {
			...
			switch (_v0.a.$) {
				...
				case 'OnDrop':
					if (_v0.b.$ === 'DisplayBookmarks') {
						...
						var from = _v20.a;
						var _v21 = _v0.b;
						var updatedBookmarks = A3($author$project$Main$move, from, to, model.bookmarks);
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{bookmarks: updatedBookmarks}),
...
var $author$project$Main$inputFormView = function (bookmark) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Main$bookmarkEditorView = function (bookmark) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$inputFormView(bookmark),
				$author$project$Main$saveButtonView,
...
var $author$project$Main$faviconUrl = F2(
...
var $author$project$Main$defaultSizedFaviconUrl = A2($author$project$Main$flip, $author$project$Main$faviconUrl, 32);
var $author$project$Main$droppable = F2(
	function (index, node) {
		return A3(
			$author$project$Main$dnd.droppable,
			index,
			_List_fromArray(
				[
	...
	function (i, bookmark) {
		...
		return A2(
			...
			_List_fromArray(
				[
					A2(
					$author$project$Main$droppable,
					i,
					A3(
						$author$project$Main$dnd.draggable,
...
var $author$project$Main$dragged = function (_v0) {
	var bookmark = _v0.b;
	return A2(
		$elm$html$Html$div,
		_List_Nil,
...
var $author$project$Main$newBookmarkAddButtonView = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Events$onClick(
			$author$project$Main$OpenEdit($author$project$Main$NewBookmark)),
					...
					return _Utils_ap(
						_List_fromArray(
							[
								...
								A2($ir4y$elm_dnd$DnD$dragged, model.draggable, $author$project$Main$dragged)
							]),
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$value)({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.Bookmark":{"args":[],"type":"{ url : Main.Url, title : Main.Title }"},"Main.Title":{"args":[],"type":"String.String"},"Main.Url":{"args":[],"type":"String.String"},"DnD.MousePosition":{"args":[],"type":"{ x : Basics.Int, y : Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"LoadBookmarks":[],"OpenEdit":["Main.EditType"],"Edit":["Main.EditMsg"],"Save":[],"Cancel":[],"Remove":["Basics.Int"],"FetchSource":[],"GotSource":["Result.Result Http.Error (List.List Main.Bookmark)"],"InputLoaderSource":["String.String"],"ExportBookmarks":[],"OnDrop":["Basics.Int","( Basics.Int, Main.Bookmark )"],"DnDMsg":["DnD.Msg Basics.Int ( Basics.Int, Main.Bookmark )"]}},"Main.EditMsg":{"args":[],"tags":{"InputUrl":["Main.Url"],"InputTitle":["Main.Title"]}},"Main.EditType":{"args":[],"tags":{"NewBookmark":[],"KnownBookmark":["Basics.Int","Main.Bookmark"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"DnD.Msg":{"args":["dropMeta","dragMeta"],"tags":{"DragStart":["dragMeta","DnD.MousePosition"],"Dragging":["DnD.MousePosition"],"DragEnd":["DnD.MousePosition"],"EnterDroppable":["dropMeta"],"LeaveDroppable":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));