...
var $author$project$View$BookmarkEditor$cancelButtonView = function (msg) {
	return A3(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$View$BookmarkEditor$cancelButtonView(cancelMsg)
				]));
	});
...
var $author$project$View$BookmarkList$bookmarkView = F5(
	function (dnd, openHandler, removeHandler, i, bookmark) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$View$BookmarkList$bookmarkListView = F5(
	function (rowLength, dnd, openHandler, removeHandler, bookmarks) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			A2(
				...
				F2(
					function (i, b) {
						return A5($author$project$View$BookmarkList$bookmarkView, dnd, openHandler, removeHandler, i, b);
					}),
				bookmarks));
	});
...
var $author$project$View$Loader$loaderView = F2(
	function (inputHandler, fetchMsg) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			switch (_v0.$) {
				case 'DisplayBookmarks':
					return _Utils_ap(
						_List_fromArray(
							[
								A5($author$project$View$BookmarkList$bookmarkListView, model.rowLength, $author$project$Main$dnd, $author$project$Main$OpenEdit, $author$project$Main$Remove, model.bookmarks),
				...
				default:
					return _List_fromArray(
						[
							A2($author$project$View$Loader$loaderView, $author$project$Main$InputLoaderSource, $author$project$Main$FetchSource)
						]);
			}
		}());
};
