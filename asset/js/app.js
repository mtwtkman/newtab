...
var $author$project$View$Widget$buttonViewWrapper = F3(
...
var $author$project$View$CancelButton$cancelButtonView = function (msg) {
	return A3(
		$author$project$View$Widget$buttonViewWrapper,
		_List_fromArray(
			[
...
var $author$project$View$Loader$loaderView = F3(
	function (inputHandler, fetchMsg, cancelMsg) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
		...
		function () {
			...
			switch (_v0.$) {
				...
				default:
					return _List_fromArray(
						[
							A3($author$project$View$Loader$loaderView, $author$project$Main$InputLoaderSource, $author$project$Main$FetchSource, $author$project$Main$Cancel)
						]);
			}
		}());
};
